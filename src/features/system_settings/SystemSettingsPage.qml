...
Item {
    ...
    Component.onCompleted: updateDiagnostics()
    ...
    UiScrollView {
        ...
        ColumnLayout {
            ...
            Rectangle {
                Layout.fillWidth: true
                Layout.preferredHeight: Theme.space["3"] * 13
                radius: Theme.radii.xl
                color: panelBg
                border.width: 1
                border.color: panelBorder
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        Label { text: "插件导入"; font.bold: true; color: textMain; font.family: Theme.fontFamily.ui }
                        Label {
                            text: hasSettingsVm ? systemSettingsVm.pluginImportMessage : "插件导入服务不可用"
                            color: hasSettingsVm && systemSettingsVm.pluginImportOk ? successColor : textMuted
                            font.pixelSize: Theme.fontSize.body
                            font.family: Theme.fontFamily.ui
                        ...
                        Label {
                            text: hasSettingsVm ? systemSettingsVm.importedPluginRoot : ""
                            color: textSubtle
                    ...
                    RowLayout {
                        ...
                        UiButton {
                            ...
                            implicitWidth: 70
                            enabled: hasSettingsVm
                            onClicked: pluginZipDialog.open()
                        }
                        UiButton {
                            text: "打开目录"
                            dark: root.dark
                            ...
                            implicitWidth: 86
                            enabled: hasSettingsVm
                            onClicked: systemSettingsVm.openImportedPluginRoot()
                        }
                    }
                }
            }
    ...
    FolderDialog {
        ...
        onAccepted: {
            if (!hasSettingsVm)
                return
            systemSettingsVm.importPlugin(String(selectedFolder))
    ...
    FileDialog {
        ...
        onAccepted: {
            if (!hasSettingsVm)
                return
            systemSettingsVm.importPlugin(String(selectedFile))
            root.updateDiagnostics()
        }
    }
