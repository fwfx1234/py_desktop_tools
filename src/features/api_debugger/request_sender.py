...
from .service import ApiDebuggerService
...
class RequestSender:
    def __init__(
        ...
        *,
        ...
        self._runner = task_runner or PythonTaskRunner(thread_name_prefix="api-debugger")
        self._sending = False
        self._active_request_id = ""
        self._disposed = False
        self._lock = Lock()
        self._log = get_logger("features.api_debugger.request_sender", plugin_id="api-debugger")
